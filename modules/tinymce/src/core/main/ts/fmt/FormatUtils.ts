...
/**
 * Checks if the two formats are equivalent based on the tag, attributes, styles and classes
 */
const areEquivalentFormats = (editor: Editor, formatName: string, otherFormatName: string) => {
